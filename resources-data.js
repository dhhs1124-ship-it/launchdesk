...
(function(root, factory){
  ...
  var GUIDES = {
    ...
    'ad-before-start': { rich: true, intro: '광고비는 쓰는 순간 지출이 됩니다. 아래 7가지를 순서대로 점검해 두면, 광고를 켠 뒤 성과가 나빠도 "무엇이 원인인지"를 나눠서 볼 수 있습니다.', blocks: [
      { t: 'h3', text: '결론부터' },
      { t: 'p', text: '광고를 켜기 전에 정해 둘 것은 세 가지입니다.' },
      { t: 'numbered', items: [
        '이번 광고로 무엇을 얻을지 정하기',
        '상품 1개가 팔릴 때 광고비를 빼기 전 얼마가 남는지 계산하기',
        '광고 결과를 어떤 숫자로 측정할지 정하기'
      ] },
      { t: 'p', text: '이 세 가지가 비어 있으면 광고 결과가 좋지 않아도 무엇이 원인인지 구분하기 어렵습니다.' },
      { t: 'note', text: '이 가이드는 광고 성과를 약속하지 않습니다. 광고를 켜기 전에 확인할 수 있는 준비 상태를 점검하는 용도이며, 광고 관리자의 메뉴 위치나 조작 방법은 다루지 않습니다.' },

      { t: 'step', num: 1, title: '광고 목표 정하기', fields: [
        { label: '왜 확인하나요', text: '목표가 다르면 봐야 할 숫자도, "잘 됐다"의 기준도 달라집니다. 방문자를 늘리려는 광고와 첫 구매를 만들려는 광고를 같은 잣대로 보면 판단이 흔들립니다.' },
        { label: '무엇을 확인하나요', items: [
          '방문자 늘리기 — 우리 쇼핑몰을 처음 보는 사람을 데려오는 것입니다. 링크 클릭수, CPC, 랜딩페이지 조회를 봅니다.',
          '첫 구매 만들기 — 처음 온 사람이 처음 사는 것입니다. 구매 수, CPA, ROAS, 광고비 차감 후 남는 공헌이익을 봅니다.',
          '재구매 만들기 — 이미 산 사람이 다시 사는 것입니다. 재구매 주문 수와 재구매 고객의 CPA를 따로 봅니다.',
          '한 캠페인에는 목표를 하나만 둡니다. 방문자 늘리기, 첫 구매, 재구매를 한 캠페인에서 모두 기대하면 결과를 봐도 무엇이 원인인지 나눌 수 없습니다.'
        ] },
        { label: '완료 기준', text: '이번 광고의 목표를 위 세 가지 중 하나로 적었고, 그 목표를 판단할 숫자 2~3개를 골랐습니다.' }
      ] },

      { t: 'step', num: 2, title: '누구에게 무엇을 팔지 한 문장으로 정리', fields: [
        { label: '왜 확인하나요', text: '이 문장이 써지지 않으면 소재, 문구, 상세페이지가 서로 다른 말을 하게 됩니다. 광고에서 본 약속과 페이지의 내용이 다르면 클릭한 사람이 바로 나가기 쉽습니다.' },
        { label: '무엇을 확인하나요', items: [
          ...
          '구매 이유는 상품 페이지에서 사진이나 글로 실제 확인되는 사실만 적습니다. 확인할 수 없는 장점은 넣지 않습니다.'
        ] },
        { label: '완료 기준', text: '한 문장을 적었고, 그 문장의 "구매 이유"를 상품 페이지 첫 화면에서 찾을 수 있습니다.' }
      ] },

      { t: 'step', num: 3, title: '광고 전에 상품 페이지 점검', fields: [
        { label: '왜 확인하나요', text: '광고는 사람을 상품 페이지까지만 데려옵니다. 살지 말지는 페이지가 정합니다. 광고를 켠 뒤에야 페이지에 빠진 정보를 발견하면, 그 사이에 쓴 광고비는 돌려받을 수 없습니다.' },
        { label: '무엇을 확인하나요', items: [
          '가격 — 옵션을 바꿀 때 가격이 어떻게 달라지는지까지 보이는가',
          '혜택 — 쿠폰·적립금·사은품이 있다면 조건(기간, 최소 금액)이 함께 적혀 있는가',
          '배송비 — 무료배송 기준과 추가 배송비(도서산간 등)가 결제 전에 보이는가',
          '배송기간 — 출고일과 도착 예상일이 적혀 있는가',
          '교환·반품 — 가능한 기간, 배송비 부담, 불가 사유가 적혀 있는가',
          '신뢰 요소 — 실제 사진, 후기, 사업자 정보, 문의 채널이 있는가'
        ], blocks: [
          { t: 'h3', text: '휴대폰에서 직접 구매 테스트' },
          { t: 'numbered', items: [
            '광고를 볼 사람이 쓸 휴대폰으로 상품 링크(UTM을 붙였다면 그 링크)를 엽니다.',
            '첫 화면에서 상품, 가격, 구매 이유가 보이는지 확인합니다.',
            '옵션을 고르고 장바구니에 담습니다.',
            '결제 직전 화면까지 이동해 배송비가 포함된 최종 금액과 결제수단을 확인합니다. 가능하면 소액 테스트 주문을 한 번 끝까지 해 봅니다.',
            '느리게 열린 곳, 글자가 작아 읽기 어려운 곳, 눌러도 반응이 없는 버튼을 메모합니다.'
          ] }
        ] },
        { label: '완료 기준', text: '위 6가지가 모두 페이지에서 찾아지고, 휴대폰에서 옵션 선택부터 결제 직전 화면까지 막힘 없이 갔습니다. 막힌 곳은 고친 뒤 다시 확인했습니다.' }
      ] },

      { t: 'step', num: 4, title: '광고 전 공헌이익 계산', fields: [
        { label: '왜 확인하나요', text: 'ROAS는 매출 기준이라 남는 돈을 알려 주지 않습니다. 그래서 광고를 켜기 전에 "상품 1개를 팔면 광고비를 빼기 전에 얼마가 남는지"를 먼저 알아야 합니다. 그래야 주문 1건에 쓸 수 있는 광고비의 한도를 정할 수 있습니다.' },
        { label: '무엇을 확인하나요', items: [
          '판매가는 고객이 실제로 결제하는 금액으로 적습니다. 결제 금액에 이미 반영된 할인은 다시 빼지 않습니다.',
          '판매자가 따로 부담하는 적립금·쿠폰·사은품 비용은 변동비에 넣습니다.',
          '광고비는 이 계산에 넣지 않습니다. 계산이 끝난 뒤에 비교합니다.'
        ], blocks: [
          { t: 'table', caption: '광고 전 공헌이익 계산 예시(가상)', head: ['항목', '예시(가상)', '설명'], rows: [
            ['판매가(고객 결제 금액)', '50,000원', '주문 1건의 결제 금액'],
            ['상품원가', '18,000원', '상품을 사 오거나 만드는 데 든 돈'],
            ['판매수수료', '3,500원', '플랫폼·결제 수수료 등'],
            ['실제 배송비', '3,000원', '택배사에 실제로 내는 배송비'],
            ['포장비', '1,000원', '박스·완충재·테이프 등'],
            ['판매자 부담 적립금 · 쿠폰 등', '4,500원', '판매자가 따로 부담하는 혜택 비용'],
            ['광고비를 뺀 변동비 합계', '30,000원', '위 5개 항목의 합'],
            ['광고 전 공헌이익(주문 1건)', '20,000원', '50,000 − 30,000'],
            ['광고 전 공헌이익률', '40%', '20,000 ÷ 50,000 × 100'],
            ['손익분기 ROAS', '250%', '100 ÷ 0.4'],
            ['주문당 광고비 한도(손익분기 CPA)', '20,000원', '주문 1건에 쓴 광고비가 이 금액이면 손익이 0원']
          ] },
          { t: 'formula', items: [
            { term: '광고 전 공헌이익(주문 1건)', formula: '판매가 − 광고비를 뺀 변동비 합계', desc: '광고비를 쓰기 전, 상품 1개를 팔았을 때 남는 돈' },
            { term: '광고 전 공헌이익률', formula: '광고 전 공헌이익 ÷ 판매가 × 100', desc: '판매가 중 광고비를 쓰기 전에 남는 비율' },
            { term: '손익분기 ROAS', formula: '100 ÷ 광고 전 공헌이익률(소수) · 예: 100 ÷ 0.4 = 250%', desc: '광고비까지 넣었을 때 손익이 0원이 되는 ROAS입니다. 내 ROAS가 이 값보다 높아야 광고비를 낸 뒤에도 돈이 남습니다.' }
          ] },
          { t: 'note', text: '세금, 반품·교환 비용, 고정비(월 구독료 등)는 이 표에 넣지 않았습니다. 필요한 손익분기 ROAS는 이 값보다 높아질 수 있으니, 내 상품의 실제 숫자로 다시 계산하세요.' },
      ...
      { t: 'step', num: 5, title: '전환 측정 준비', fields: [
        { label: '왜 확인하나요', text: '광고 관리자의 구매 수와 실제 주문이 어긋나면 CPA와 ROAS를 믿고 판단할 수 없습니다. 측정 준비는 광고를 켜기 전에 끝내 두는 편이 안전합니다.' },
        { label: '무엇을 확인하나요', items: [
          '구매 완료 이벤트 — 결제가 끝난 시점에 1번만 기록되는지 확인합니다. GA4 공식 문서는 구매 이벤트에 주문 고유번호(transaction_id), 결제 금액(value), 통화(currency)를 함께 보내도록 안내합니다.',
          '측정 도구 — GA4는 쇼핑몰 안에서의 행동을, Meta 픽셀은 Meta 광고를 보고 온 사람의 행동과 전환을 잽니다. 사용할 도구가 실제로 구매를 기록하는지 확인합니다.',
          'UTM — 광고 링크 끝에 "어느 광고에서 왔는지"를 알려 주는 꼬리표를 붙입니다. utm_source, utm_medium, utm_campaign을 함께 쓰고, 소재를 구분하려면 utm_content도 씁니다. 값은 대소문자를 구분하므로 소문자로 통일합니다.',
          '테스트 주문 — 직접 주문을 한 번 해서 구매 이벤트가 1번만 들어오는지, 금액과 주문번호가 실제 주문과 같은지 봅니다. GA4는 DebugView에서 이벤트를 실시간으로 볼 수 있습니다.',
          '플랫폼 숫자와 실제 주문 대조 — 광고 플랫폼, GA4, 쇼핑몰 주문 목록은 집계 기준(기여 기간, 시간대, 전환 날짜 기준 등)이 달라 숫자가 서로 맞지 않을 수 있습니다. Meta 도움말도 타사 도구와 전환 수가 다를 수 있다고 안내합니다. 그래서 실제 주문을 기준으로 삼고 광고 숫자는 그와 비교해 읽습니다.'
        ], blocks: [
          { t: 'formula', items: [
            { term: 'UTM 링크 예시(가상)', formula: 'https://example.com/products/1?utm_source=meta&utm_medium=paid_social&utm_campaign=launch_test_01&utm_content=video_a', desc: 'source = 어디서 왔나(meta) · medium = 어떤 종류의 광고인가(paid_social) · campaign = 어떤 광고 묶음인가(launch_test_01) · content = 어떤 소재인가(video_a)' }
          ] },
          { t: 'cta', label: 'GA4 · Meta 픽셀 · UTM 기본 보기', slug: 'ga4-pixel-utm' }
        ] },
        { label: '완료 기준', text: '테스트 주문 1건이 사용하는 측정 도구에 1번만 기록되고, 금액과 주문번호가 실제 주문과 같습니다. 광고 링크에 UTM이 붙어 있습니다.' }
      ] },

      { t: 'step', num: 6, title: '테스트 예산과 기간 결정', fields: [
        { label: '왜 확인하나요', text: '광고 결과는 하루 안에서도 크게 흔들리고, 구매 수가 적을 때는 우연의 영향이 큽니다. 감당할 수 있는 한도를 먼저 정해 두지 않으면, 결과가 나쁠 때 손실을 통제하기 어렵습니다.' },
        { label: '무엇을 확인하나요', items: [
          '감당 가능한 손실 한도 — 이번 테스트에서 구매가 0건이어도 생활비와 재고·배송 비용을 내는 데 지장이 없는 금액을 적습니다. 이 금액이 테스트 총예산의 상한입니다. 얼마가 적당하다는 정해진 금액은 없습니다.',
          '손익분기에 필요한 구매 수 — 테스트 예산 ÷ 주문당 광고비 한도입니다. 예시 쇼핑몰이 100,000원을 쓰면 100,000 ÷ 20,000 = 5건이 나와야 광고비와 공헌이익이 같아집니다. 이 숫자가 예산에 비해 너무 크게 느껴지면 예산, 가격, 마진 중 무엇을 바꿀지 먼저 고민합니다.',
          '기간 — 며칠이면 충분한지는 상품·예산·구매 수에 따라 달라 정해진 답이 없습니다. 대신 "최대 며칠까지"와 "구매가 몇 건 쌓일 때까지"를 시작 전에 함께 적어 둡니다.',
          '하루 결과만 보고 결론 내리지 않기 — Meta 도움말도 일일 예산은 하루 단위로 정확히 맞춰지지 않고 날마다 지출이 달라질 수 있다고 설명합니다. 좋은 날도 나쁜 날도 기록만 하고, 정해 둔 기간이 끝난 뒤 합쳐서 판단합니다. 다만 잘못된 링크나 결제 오류처럼 분명한 오류는 바로 고칩니다.',
          '한 번에 하나만 바꾸기 — 소재, 타깃, 가격, 상품 페이지 중 하나만 바꿉니다. 여러 개를 함께 바꾸면 무엇 때문에 달라졌는지 알 수 없습니다.'
        ] },
        { label: '완료 기준', text: '테스트 총예산 상한(원), 시작일과 종료 조건(최대 일수 · 목표 구매 수), 손익분기에 필요한 구매 수를 적었습니다.' }
      ] },

      { t: 'step', num: 7, title: '기록표 만들기', fields: [
        { label: '왜 확인하나요', text: '기억이 아니라 숫자로 원인을 좁히려면 같은 항목을 같은 순서로 꾸준히 적어야 합니다. "무엇을 언제 바꿨는지"까지 남아 있어야 결과가 달라진 이유를 찾을 수 있습니다.' },
        { label: '무엇을 확인하나요', items: [
          '아래 표의 항목을 스프레드시트나 노트에 열로 만듭니다. 광고를 켜기 전에 공헌이익률, 손익분기 ROAS, 주문당 광고비 한도를 첫 줄에 적어 둡니다.',
          'LaunchDesk 광고 기록은 날짜, 채널, 소재명, 지출, 전환 매출을 입력하면 ROAS를 계산해 줍니다. 노출, 클릭, 랜딩페이지 조회, 장바구니, CPA, 메모 칸은 없으니 이 항목들은 스프레드시트나 노트에 함께 적어 두세요.'
        ], blocks: [
          { t: 'table', caption: '광고 기록표에 적을 항목', head: ['항목', '적는 값', '어디서 확인하나요'], rows: [
            ['날짜', '기록한 날(기간을 나눴다면 시작일~종료일)', '직접 입력'],
            ['광고비', '쓴 광고비(원)', '광고 플랫폼'],
            ['노출', '광고가 화면에 보인 횟수', '광고 플랫폼'],
            ['클릭', '링크 클릭수', '광고 플랫폼'],
            ['랜딩페이지 조회', '클릭 뒤 페이지가 열린 횟수', '광고 플랫폼(픽셀), GA4'],
            ['장바구니', '상품을 담은 횟수', 'GA4 또는 광고 플랫폼'],
            ['구매', '결제 완료 주문 수', '쇼핑몰 주문 목록(기준), GA4, 광고 플랫폼'],
            ['매출', '구매 금액 합계(원)', '쇼핑몰 주문 목록(기준), GA4, 광고 플랫폼'],
            ['CPA', '광고비 ÷ 구매 수', '직접 계산'],
            ['ROAS', '매출 ÷ 광고비 × 100', '직접 계산 또는 LaunchDesk 광고 기록'],
            ['메모', '바꾼 것과 바꾼 시각, 특이사항', '직접 입력']
          ] },
          { t: 'cta', label: '광고 기록 남기기', href: '#/dashboard' }
        ] },
        { label: '완료 기준', text: '기록표를 만들었고, 첫 줄에 광고를 켜기 전 기준값(공헌이익률, 손익분기 ROAS, 주문당 광고비 한도)을 적었습니다.' }
      ] },
    ...
    'ad-metrics': { rich: true, intro: '광고 숫자는 하나의 흐름으로 이어져 있습니다. 숫자 하나로 좋고 나쁨을 판단하지 말고, 사람이 어느 단계에서 줄어드는지, 그리고 마지막에 돈이 남는지를 순서대로 확인하세요.', blocks: [
      { t: 'h3', text: '결론부터' },
      { t: 'p', text: '광고 숫자는 세 번에 나눠 읽습니다.' },
      { t: 'numbered', items: [
        '사람이 어디서 줄어드는가 (노출 → 클릭 → 방문 → 장바구니 → 결제 → 구매)',
        '구매 1건을 얻는 데 광고비가 얼마 드는가 (CPA)',
        '그 광고비를 내고도 돈이 남는가 (손익분기 ROAS, 광고비 차감 후 남는 공헌이익)'
      ] },
      { t: 'p', text: 'ROAS 하나만 보면 매출을 이익으로 착각하기 쉽습니다.' },

      { t: 'h3', text: '이 가이드의 예시 쇼핑몰' },
      { t: 'p', text: '아래 모든 계산은 같은 가상 쇼핑몰의 숫자를 씁니다. 실제 쇼핑몰의 평균이나 기준이 아니라, 계산 방법을 익히기 위한 숫자입니다.' },
      ...
      { t: 'h3', text: '광고 숫자의 흐름' },
      { t: 'p', text: '노출 → 클릭 → 랜딩페이지 도착 → 장바구니 → 결제 시작 → 구매 → 매출과 이익' },
      { t: 'p', text: '앞 단계에서 사람이 많이 사라졌다면 뒤 단계의 숫자는 원인이 아니라 결과입니다. 그래서 항상 앞 단계부터 확인합니다.' },
      { t: 'table', caption: '광고 흐름 단계와 예시 쇼핑몰의 숫자', head: ['단계', '무엇을 세나요', '예시 쇼핑몰'], rows: [
        ['노출', '광고가 화면에 보인 횟수', '20,000회'],
        ['클릭', '광고 안의 링크를 누른 횟수', '200회 (CTR 1%)'],
        ['랜딩페이지 도착', '클릭한 뒤 상품 페이지가 실제로 열린 횟수', '예시 데이터에 없음 — 내 숫자로 확인'],
        ['장바구니', '상품을 장바구니에 담은 횟수', '예시 데이터에 없음'],
        ['결제 시작', '결제 화면에 들어간 횟수', '예시 데이터에 없음'],
        ['구매', '결제까지 끝난 주문 수', '8건 (링크 클릭 대비 구매 전환율 4%)'],
        ['매출과 이익', '매출에서 원가·수수료 등과 광고비를 뺀 뒤 남는 돈', '매출 400,000원 → 광고비 차감 후 공헌이익 60,000원']
      ] },

      { t: 'h3', text: '지표별로 읽는 법' },
      { t: 'p', text: '지표마다 "뜻 → 계산식 → 예시 → 숫자가 변했을 때 먼저 확인할 것" 순서로 적었습니다. 광고 관리자에서 도달, 빈도, 일부 전환 지표는 추산치로 표시될 수 있습니다.' },
      { t: 'formula', items: [
        { term: '노출수', formula: '광고 플랫폼이 세는 값(직접 계산하지 않음)', desc: '광고가 화면에 보인 횟수입니다. 같은 사람에게 여러 번 보이면 그만큼 더해집니다.', example: '20,000회', check: '갑자기 줄었다면 광고가 정상적으로 게재되고 있는지(상태 · 심사 · 결제 · 일정 · 예산)부터 확인합니다.' },
        { term: '도달수', formula: '광고 플랫폼이 세는 값(추산치일 수 있음)', desc: '광고를 한 번 이상 본 사람(계정)의 수입니다. 같은 사람이 여러 번 봐도 1명으로 셉니다.', example: '이 예시 데이터에는 없습니다', check: '노출수는 늘었는데 도달수가 거의 그대로라면 같은 사람에게 반복해서 보이고 있다는 뜻이므로 빈도를 함께 봅니다.' },
        { term: '빈도', formula: '노출수 ÷ 도달수', desc: '한 사람이 광고를 본 평균 횟수입니다.', example: '이 예시 데이터에는 도달수가 없어 계산하지 않습니다', check: '빈도가 올라가는데 성과가 나빠진다면 같은 사람이 광고에 피로를 느끼는 것일 수 있습니다. 소재나 타깃을 바꿔 볼 만합니다(Meta 도움말).' },
        { term: 'CPM', formula: '광고비 ÷ 노출수 × 1,000', desc: '광고가 1,000번 보이는 데 든 비용입니다.', example: '100,000 ÷ 20,000 × 1,000 = 5,000원', check: 'CPM만으로 성과를 판단하지 말고 클릭·구매 비용과 함께 봅니다. Meta 도움말도 전환에 맞춰 최적화한 광고는 CPM만 봐서는 성과를 파악하기 어렵다고 설명합니다.' },
        { term: '링크 클릭수', formula: '광고 플랫폼이 세는 값', desc: '광고 안의 링크를 눌러 쇼핑몰 등으로 이동한 횟수입니다. "클릭(전체)"와는 다른 지표이니 계산에는 링크 클릭을 씁니다.', example: '200회', check: '클릭에 비해 랜딩페이지 조회가 크게 적으면 페이지가 열리기 전에 이탈했거나 링크·추적에 문제가 있을 수 있습니다.' },
        { term: 'CTR', formula: '링크 클릭수 ÷ 노출수 × 100', desc: '광고가 보인 횟수 중 링크 클릭으로 이어진 비율입니다. 소재와 문구가 눈길을 끌었는지 보여 줍니다.', example: '200 ÷ 20,000 × 100 = 1%', check: '내려갔다면 소재 첫 화면, 문구, 같은 사람에게 반복 노출되는지(빈도)를 확인합니다. 올랐는데 구매가 늘지 않으면 다음 단계인 페이지를 봅니다.' },
        { term: 'CPC', formula: '광고비 ÷ 링크 클릭수', desc: '링크 클릭 1번을 얻는 데 든 광고비입니다.', example: '100,000 ÷ 200 = 500원', check: '올랐다면 CPM(노출 단가)이 오른 것인지 CTR이 내려간 것인지 나눠 봅니다. 클릭 비용은 이 두 숫자의 결과이기 때문입니다.' },
        { term: '랜딩페이지 조회', formula: '광고 플랫폼(픽셀)이 세는 값 · 랜딩페이지 조회 ÷ 링크 클릭수 × 100으로 비율을 봅니다', desc: '광고를 누른 뒤 페이지가 실제로 열린 횟수입니다. 링크 클릭과 항상 같지는 않습니다.', example: '이 예시 데이터에는 없습니다', check: '링크 클릭보다 크게 적으면 주소 오류, 느린 로딩, 리디렉션, 픽셀 설치 상태를 확인합니다.' },
        { term: '장바구니', formula: '장바구니 담기 횟수 ÷ 랜딩페이지 조회 × 100', desc: '상품을 장바구니에 담은 횟수입니다. 페이지를 본 사람이 살 마음이 생겼는지 보여 줍니다.', example: '이 예시 데이터에는 없습니다', check: '방문에 비해 적으면 가격, 상품 설명, 배송비·배송기간 표시, 후기, 옵션 선택의 복잡함을 확인합니다.' },
        { term: '결제 시작', formula: '결제 시작 횟수 ÷ 장바구니 담기 횟수 × 100', desc: '장바구니에서 결제 화면으로 넘어간 횟수입니다.', example: '이 예시 데이터에는 없습니다', check: '장바구니에 비해 적으면 배송비가 뒤늦게 붙는지, 회원가입을 강제하는지, 쿠폰이 제대로 적용되는지 확인합니다.' },
        { term: '구매', formula: '구매 이벤트 수 · 쇼핑몰 실제 주문 목록과 대조', desc: '결제까지 끝난 주문 수입니다.', example: '8건', check: '광고 관리자의 구매 수와 쇼핑몰 실제 주문 수를 같은 기간 · 같은 기준으로 대조합니다. 다르면 추적 설정부터 봅니다.' },
        { term: '구매 전환율', formula: '구매 수 ÷ 링크 클릭수 × 100', desc: '링크를 누른 사람 중 실제로 산 사람의 비율입니다. 이 가이드는 링크 클릭을 분모로 씁니다. 도구마다 분모가 달라(예: Google Ads는 추적 가능한 광고 상호작용) 다른 도구의 숫자와 섞어 비교하지 않습니다.', example: '8 ÷ 200 × 100 = 4%', check: '내려갔다면 흐름 순서대로 랜딩페이지 조회 → 장바구니 → 결제 시작 중 어디서 줄었는지 찾습니다.' },
        { term: 'CPA', formula: '광고비 ÷ 구매 수', desc: '구매 1건을 얻는 데 든 광고비입니다. Google Ads의 "Cost / conv."(전환 1건당 비용)와 같은 방식의 계산입니다.', example: '100,000 ÷ 8 = 12,500원', check: '올랐다면 CPC와 구매 전환율 중 무엇이 변했는지 봅니다. CPA는 CPC ÷ 구매 전환율과 같습니다(500 ÷ 0.04 = 12,500).' },
        { term: '매출', formula: '구매 수 × 객단가(또는 결제 금액의 합계)', desc: '광고로 발생한 것으로 집계된 구매 금액입니다.', example: '8 × 50,000 = 400,000원', check: '매출이 변했다면 구매 수와 객단가 중 무엇이 변했는지 나눠 봅니다.' },
        { term: 'ROAS', formula: '매출 ÷ 광고비 × 100', desc: '광고비 1원당 매출이 얼마인지 보여 줍니다. 도구에 따라 4배 또는 400%처럼 표시가 달라도 같은 값입니다. 이익이 아니라 매출 기준입니다.', example: '400,000 ÷ 100,000 × 100 = 400%', check: '매출과 광고비 중 무엇이 변했는지 보고, 꼭 손익분기 ROAS와 함께 비교합니다.' },
        { term: '광고 전 공헌이익', formula: '주문 1건: 판매가 − 광고비를 뺀 변동비 · 전체: 주문 1건당 공헌이익 × 구매 수', desc: '광고비를 쓰기 전에 남는 돈입니다. 판매가에서 상품원가, 판매수수료, 실제 배송비, 포장비, 할인·쿠폰 등 광고비를 제외한 변동비를 뺍니다.', example: '주문 1건 50,000 − 30,000 = 20,000원 · 전체 8 × 20,000 = 160,000원 · 광고 전 공헌이익률 20,000 ÷ 50,000 × 100 = 40%', check: '상품 가격, 원가, 배송비, 할인이 바뀌면 다시 계산합니다. 이 값이 바뀌면 손익분기 ROAS도 바뀝니다.' },
        { term: '손익분기 ROAS', formula: '100 ÷ 광고 전 공헌이익률(소수)', desc: '광고비까지 넣었을 때 손익이 0원이 되는 ROAS입니다. 내 ROAS가 이 값보다 높아야 광고비를 낸 뒤에도 돈이 남습니다.', example: '100 ÷ 0.4 = 250%', check: '내 ROAS가 이 값보다 높은지 낮은지 봅니다. 공헌이익률이 바뀌면 이 기준선 자체가 움직입니다.' },
        { term: '광고비 차감 후 남는 공헌이익', formula: '광고 전 총 공헌이익 − 광고비', desc: '광고비까지 낸 뒤 실제로 남는 돈(예시에 넣은 비용 기준)입니다. 마이너스라면 광고비가 공헌이익보다 컸다는 뜻입니다.', example: '160,000 − 100,000 = 60,000원', check: '마이너스라면 CPA가 주문 1건당 광고 전 공헌이익보다 큰지, 객단가나 변동비가 예상과 다른지 순서대로 봅니다.' }
      ] },

      { t: 'h3', text: '예시 쇼핑몰 계산 결과 한눈에' },
      ...
      { t: 'h3', text: 'ROAS 400%는 매출 400,000원이 전부 이익이라는 뜻이 아닙니다' },
      { t: 'p', text: '매출 400,000원 안에는 상품원가, 수수료, 배송비, 포장비 같은 변동비가 이미 들어 있습니다. 예시 쇼핑몰은 주문 1건당 30,000원이므로 8건이면 240,000원이 나갑니다. 남은 160,000원에서 광고비 100,000원을 내야 60,000원이 남습니다.' },
      { t: 'table', caption: '매출 400,000원이 남는 돈이 되기까지', head: ['단계', '금액'], rows: [
        ['매출', '400,000원'],
        ['주문 8건의 광고비 제외 변동비', '− 240,000원'],
        ['광고 전 총 공헌이익', '160,000원'],
        ['광고비', '− 100,000원'],
        ['광고비 차감 후 남는 공헌이익', '60,000원']
      ] },
      { t: 'note', text: '이 예시에는 세금, 반품·교환 비용, 판매자가 나눠 내는 쿠폰 분담금, 월 고정비(구독료 · 임대료 · 인건비 등)를 넣지 않았습니다. 이런 비용이 있으면 실제로 남는 돈은 60,000원보다 적어질 수 있고, 필요한 ROAS도 손익분기 ROAS 250%보다 높아질 수 있습니다. 손익분기 ROAS 250%는 이익이 많이 남는 기준이 아니라 손익이 0원이 되는 경계선입니다.' },
      { t: 'p', text: '공헌이익률을 퍼센트 숫자로 계산할 때는 10,000 ÷ 공헌이익률(%)로 구해도 같은 값입니다. 예: 10,000 ÷ 40 = 250%.' },

      { t: 'h3', text: '"좋은 숫자"는 어떻게 정하나요' },
      { t: 'p', text: 'CTR, CPC, ROAS에는 모든 상품에 통하는 합격선이 없습니다. 상품, 가격, 시기, 광고 형태에 따라 크게 달라지므로 이 가이드는 정해진 기준 숫자를 만들지 않습니다. 대신 아래 세 가지와 비교하세요.' },
      { t: 'list', items: [
        '같은 상품의 이전 기간 — 기간의 길이와 전환 기준을 맞춘 뒤, 이번 기간이 나아졌는지 나빠졌는지 봅니다.',
        '같은 캠페인의 소재 간 비교 — 같은 기간, 비슷한 예산 조건에서 소재끼리 나란히 놓고 봅니다. 노출과 클릭이 너무 적은 소재는 결론을 미룹니다.',
        '내 손익분기점 — ROAS가 손익분기 ROAS보다 높은지, CPA가 주문당 광고비 한도보다 낮은지 봅니다. 결국 가장 중요한 기준입니다.'
      ] },
      { t: 'note', text: '광고 플랫폼, GA4, 쇼핑몰 주문은 집계 기준이 서로 다릅니다. 다른 도구의 숫자를 섞어 계산하지 말고 한 도구 안에서 같은 기준으로 비교하세요. Meta 도움말도 기여 모델이 다른 광고 세트끼리 결과를 비교하면 정확하지 않은 결론으로 이어질 수 있다고 안내합니다.' },
    ...
    'ad-troubleshoot': { rich: true, intro: '광고 성과가 나쁘면 소재부터 바꾸고 싶어집니다. 하지만 원인을 좁히려면 사람이 줄어드는 곳을 위쪽 단계부터 차례로 확인해야 합니다. 아래 7단계를 위에서 아래로 따라가세요.', blocks: [
      { t: 'h3', text: '결론부터' },
      { t: 'p', text: '증상이 보이는 가장 위쪽 단계부터 확인합니다. 앞 단계가 막혀 있으면 뒤 단계의 숫자는 원인이 아니라 결과이기 때문입니다.' },
      { t: 'p', text: '다만 광고 관리자에는 구매가 없는데 실제 주문은 들어온다면 성과 부진이 아니라 추적 문제일 수 있으니 7단계를 먼저 확인합니다.' },
      { t: 'h3', text: '진단 전에 지킬 원칙' },
      { t: 'list', items: [
        '한 번에 한 가지 변수만 바꿉니다. 소재, 타깃, 가격, 상품 페이지 중 하나만 바꿔야 결과가 달라진 이유를 알 수 있습니다.',
        '변경 전 숫자를 먼저 기록합니다. 기준이 없으면 나아졌는지 알 수 없습니다.',
        '변경 시각과 변경 내용을 기록합니다. 예: "3일 오후 2시, 소재 A의 첫 문장만 변경".',
        '데이터가 부족한 상태에서 성급히 성공이나 실패를 단정하지 않습니다. 구매 수가 적을 때는 우연의 영향이 큽니다. Meta 도움말도 지출과 성과가 하루 단위로 달라질 수 있다고 안내합니다.',
        '추적 오류와 실제 성과 부진을 구분합니다. 광고 관리자 숫자와 실제 주문이 다르면 성과를 판단하기 전에 7단계부터 확인합니다.'
      ] },
      { t: 'note', text: 'CTR, CPC, ROAS에는 모든 상품에 통하는 합격선이 없습니다. 이전 기간, 같은 캠페인의 다른 소재, 내 손익분기점과 비교하세요(자세한 계산은 "광고 숫자 읽는 법").' },
      { t: 'note', text: '이 가이드는 광고 플랫폼 화면의 조작 방법을 다루지 않습니다. 메뉴 위치와 심사 기준은 자주 바뀌므로 화면에서 막히면 각 플랫폼의 공식 도움말을 함께 확인하세요.' },

      { t: 'step', num: 1, id: 's1', title: '광고가 집행되지 않거나 노출이 거의 없음', fields: [
        { label: '보이는 증상', text: '광고 관리자에서 노출수가 0이거나, 시간이 지나도 거의 늘지 않고 지출도 거의 없습니다.' },
        { label: '가능한 원인', items: [
          '캠페인 · 광고 세트 · 광고 중 하나가 꺼져 있거나 일시중지 상태입니다.',
          '광고 심사가 끝나지 않았거나 반려되었습니다.',
          '결제수단에 문제가 생겨 게재가 멈췄습니다.',
          '일정이 아직 시작 전이거나 이미 끝났습니다.',
          '예산이 너무 낮거나 이미 다 쓰였습니다.',
          '타깃 범위가 너무 좁거나 제외 조건이 과합니다.',
          '계정에 제한이나 정책 문제가 있습니다.'
        ] },
        { label: '먼저 확인할 것', items: [
          '캠페인 → 광고 세트 → 광고 순서로 모두 켜져 있는지',
          '심사 상태와 반려 사유 알림',
          '결제수단 오류나 결제 실패 알림',
          '시작일 · 종료일과 게재 요일 · 시간',
          '일일 예산 또는 총 예산이 남아 있는지',
          '타깃 규모가 지나치게 작지 않은지',
          '계정 제한이나 정책 알림'
        ] },
        { label: '바로 할 수 있는 조치', items: [
          '꺼진 항목을 켜고 일정과 예산을 바로잡습니다.',
          '반려되었다면 반려 사유를 읽고 해당하는 소재나 랜딩페이지를 고친 뒤 다시 제출합니다. 사유를 확인하지 않은 채 같은 소재를 반복해서 제출하지 않습니다.',
          '결제수단 오류는 플랫폼 안내에 따라 복구합니다.',
          '고친 항목과 시각을 기록합니다.'
        ] },
        { label: '다음 단계로 넘어가는 기준', text: '노출수가 다시 쌓이고 지출이 발생하면 2단계로 넘어갑니다. 계정 제한처럼 직접 풀 수 없는 문제는 플랫폼 고객센터의 안내를 따릅니다.' }
      ] },

      { t: 'step', num: 2, id: 's2', title: '노출은 있는데 클릭이 적음', fields: [
        { label: '보이는 증상', text: '노출수는 쌓이는데 링크 클릭수와 CTR이 이전 기간이나 같은 캠페인의 다른 소재보다 낮습니다. 정해진 합격선은 없으니 비교 대상은 이전 기간과 다른 소재입니다.' },
        { label: '가능한 원인', items: [
          '소재 첫 화면에서 무엇을 파는지 바로 보이지 않습니다.',
          '광고가 말하는 내용과 실제 상품이 서로 맞지 않습니다.',
          '혜택이나 구매 이유가 약하거나 보이지 않습니다.',
          '타깃이 상품과 맞지 않습니다.',
          '문구가 길거나 모호해서 눌러야 할 이유가 보이지 않습니다.',
          '행동을 유도하는 문구나 버튼이 없습니다.',
          '같은 사람에게 너무 자주 보여 반응이 떨어졌습니다(빈도가 높음).'
        ] },
        { label: '먼저 확인할 것', items: [
          'CTR을 이전 기간, 그리고 같은 캠페인의 다른 소재와 비교합니다.',
          '소재를 휴대폰 화면에서 3초만 보고 상품 · 대상 · 혜택이 떠오르는지 확인합니다.',
          '빈도가 올라가고 있는지 확인합니다.',
          '광고 문구가 "누구에게 무엇을 왜 파는지" 한 문장(광고비를 쓰기 전 확인할 7가지의 2번 항목)과 이어지는지 확인합니다.'
        ] },
        { label: '바로 할 수 있는 조치', items: [
          '한 번에 하나만 바꿉니다. 첫 화면, 첫 문장, 혜택 표현 중 하나만 다르게 한 소재를 추가합니다.',
          '기존 소재는 끄지 않고 나란히 두어 같은 조건에서 비교합니다.',
          '변경 내용과 시각을 기록합니다.'
        ] },
        { label: '다음 단계로 넘어가는 기준', text: '정해 둔 기간 동안 데이터를 모은 뒤, 클릭이 이전 기간이나 다른 소재와 비교해 나빠 보이지 않으면 3단계로 넘어갑니다. 노출이나 클릭이 너무 적으면 결론을 미루고 기간을 늘립니다.' }
      ] },

      { t: 'step', num: 3, id: 's3', title: '클릭은 있는데 랜딩페이지 조회가 적음', fields: [
        { label: '보이는 증상', text: '링크 클릭수에 비해 랜딩페이지 조회수가 눈에 띄게 적습니다. 두 지표는 서로 관련은 있지만 같은 값이 아니어서 조금 차이가 날 수 있습니다. 차이가 크고 계속될 때 아래를 점검합니다.' },
        { label: '가능한 원인', items: [
          '광고 링크(URL)가 잘못되었거나 삭제 · 품절된 페이지로 연결됩니다.',
          '모바일에서 로딩이 느려 페이지가 열리기 전에 나갔습니다.',
          '페이지 오류(접속 실패, 오류 화면)가 있습니다.',
          '주소가 여러 번 바뀌는 리디렉션 도중에 이탈하거나 추적 값이 사라집니다.',
          '픽셀이 설치되지 않았거나 오류가 있어 랜딩페이지 조회가 제대로 집계되지 않습니다.',
          '광고 안에 링크가 둘 이상이라 클릭이 다른 곳으로 갔습니다.'
        ] },
        { label: '먼저 확인할 것', items: [
          '광고 링크를 휴대폰에서 모바일 데이터로 직접 눌러 열어 봅니다.',
          '링크가 상품 페이지로 정확히 연결되는지, 주소가 바뀌는 과정에서 UTM이 사라지지 않는지 확인합니다.',
          '픽셀 이벤트가 정상적으로 들어오는지 확인합니다.'
        ] },
        { label: '바로 할 수 있는 조치', items: [
          'URL 오타나 연결된 페이지를 고칩니다.',
          '페이지 오류를 고치거나 쇼핑몰 플랫폼 고객센터에 문의합니다.',
          '큰 이미지 · 영상과 불필요한 팝업을 줄여 모바일 로딩을 가볍게 합니다.',
          '리디렉션 단계를 줄입니다.',
          '고친 내용과 시각을 기록합니다.'
        ] },
        { label: '다음 단계로 넘어가는 기준', text: '모바일에서 직접 눌렀을 때 페이지가 정상적으로 열리고, 링크 클릭 대비 랜딩페이지 조회 비율이 이전 기간 수준으로 돌아오면 4단계로 넘어갑니다.' }
      ] },

      { t: 'step', num: 4, id: 's4', title: '방문은 있는데 장바구니가 적음', fields: [
        { label: '보이는 증상', text: '페이지를 보는 사람은 있는데 장바구니에 담는 횟수가 이전 기간보다 적습니다.' },
        { label: '가능한 원인', items: [
          '가격이 비슷한 다른 상품과 비교해 매력이 부족합니다(가격 경쟁력).',
          '상품이 무엇이고 누구에게 좋은지 한눈에 이해되지 않습니다.',
          '상세페이지 정보가 부족하거나 너무 길어 핵심을 찾기 어렵습니다.',
          '배송비와 배송기간이 잘 보이지 않습니다.',
          '후기나 실제 사진 같은 믿을 만한 근거가 부족합니다.',
          '옵션이 복잡해서 고르다가 포기합니다.',
          '광고가 약속한 혜택이 페이지에서는 보이지 않습니다.'
        ] },
        { label: '먼저 확인할 것', items: [
          '휴대폰 첫 화면에서 상품, 가격, 배송비 · 기간, 구매 이유가 스크롤을 조금만 해도 보이는지 봅니다.',
          '광고와 페이지 첫 화면이 같은 약속을 하는지 확인합니다.',
          '내 상품과 비슷한 상품의 가격과 배송비를 나란히 놓고 비교합니다.',
          '옵션을 고르는 단계가 몇 번인지 세어 봅니다.'
        ] },
        { label: '바로 할 수 있는 조치', items: [
          '한 번에 하나만 바꿉니다. 예: 배송비와 배송기간을 상단에 표시, 광고와 같은 혜택 문구를 첫 화면에 추가, 옵션 단순화.',
          '가격이나 혜택을 바꿀 때는 공헌이익률과 손익분기 ROAS를 다시 계산합니다.',
          '바꾼 내용과 시각을 기록합니다.'
        ] },
        { label: '다음 단계로 넘어가는 기준', text: '장바구니 담기가 이전 기간과 비교해 회복되면 5단계로 넘어갑니다. 회복되지 않으면 기록을 보고, 바꾼 것이 하나뿐이었는지 확인한 뒤 다른 원인 후보를 하나씩 시도합니다.' }
      ] },

      { t: 'step', num: 5, id: 's5', title: '장바구니는 있는데 구매가 적음', fields: [
        { label: '보이는 증상', text: '장바구니에 담는 횟수(또는 결제 시작)에 비해 결제 완료가 적습니다.' },
        { label: '가능한 원인', items: [
          '결제 오류 — 특정 결제수단이나 특정 기기 · 브라우저에서 결제가 실패합니다.',
          '결제 단계에서 처음 보이는 추가 배송비가 부담스럽습니다.',
          '회원가입이나 로그인을 강제합니다.',
          '쿠폰이 적용되지 않거나 오류가 납니다.',
          '고객이 쓰려는 결제수단이 없습니다.',
          '교환 · 반품 조건을 몰라 불안합니다.',
          '모바일 결제 화면이 불편하거나 오류가 납니다.'
        ] },
        { label: '먼저 확인할 것', items: [
          '휴대폰으로 상품 담기부터 결제 직전(가능하면 실제 소액 주문)까지 직접 해 봅니다.',
          '비회원으로 주문할 수 있는지 확인합니다.',
          '쿠폰을 적용했을 때 최종 금액이 맞는지 확인합니다.',
          '결제수단마다 결제창이 정상적으로 열리는지 확인합니다.',
          '최종 결제 금액에 배송비가 어떻게 반영되는지 확인합니다.'
        ] },
        { label: '바로 할 수 있는 조치', items: [
          '오류가 재현되면 화면, 시각, 기기, 결제수단을 기록해 쇼핑몰 플랫폼이나 결제(PG) 고객센터에 문의합니다.',
          '배송비를 상품 페이지에서 미리 보여 줍니다.',
          '비회원 주문을 허용할 수 있는지 검토합니다.',
          '결제 화면 가까이에 교환 · 반품 안내를 둡니다.',
          '바꾼 내용과 시각을 기록합니다.'
        ] },
        { label: '다음 단계로 넘어가는 기준', text: '테스트 주문이 처음부터 끝까지 성공하고, 결제 시작 대비 구매 비율이 이전 기간 수준으로 돌아오면 6단계로 넘어갑니다.' }
      ] },

      { t: 'step', num: 6, id: 's6', title: '구매는 발생하지만 이익이 남지 않음', fields: [
        { label: '보이는 증상', text: '구매는 나오는데 광고비 차감 후 남는 공헌이익이 마이너스이거나 0원입니다. 또는 ROAS가 손익분기 ROAS보다 낮습니다.' },
        { label: '가능한 원인', items: [
          'CPA가 주문 1건당 광고 전 공헌이익보다 큽니다.',
          '객단가가 낮아 주문 1건에서 남는 돈이 적습니다.',
          '할인 · 쿠폰이 늘어 공헌이익률이 떨어졌습니다.',
          '배송비 · 포장비 · 수수료 같은 변동비가 처음 계산보다 큽니다.',
          '반품 · 교환이 많아 실제로 남는 매출이 적습니다.',
          '처음 계산한 손익분기 ROAS가 지금의 가격 · 비용과 맞지 않습니다.'
        ] },
        { label: '먼저 확인할 것', items: [
          '최근 기간의 실제 판매가와 실제 변동비로 광고 전 공헌이익률을 다시 계산합니다.',
          '손익분기 ROAS(100 ÷ 공헌이익률)와 실제 ROAS를 비교합니다.',
          '광고비 차감 후 남는 공헌이익(= 구매 수 × 주문 1건당 공헌이익 − 광고비)을 계산합니다.',
          '반품 · 교환으로 돌려준 금액을 따로 빼 봅니다.'
        ], blocks: [
        ...
        { label: '바로 할 수 있는 조치', items: [
          '변동비가 늘었다면 가격, 묶음 구성, 쿠폰 조건, 배송비 정책 중 하나만 바꿉니다.',
          'CPA가 문제라면 2~5단계 중 사람이 줄어드는 곳을 개선합니다.',
          '개선 결과가 확인될 때까지 광고 예산을 무리하게 늘리지 않고, 감당 가능한 손실 한도 안에서 유지합니다.',
          '바꾼 내용과 시각을 기록합니다.'
        ] },
        { label: '다음 단계로 넘어가는 기준', text: '실제 변동비로 계산한 손익분기 ROAS와 광고비 차감 후 남는 공헌이익을 기록으로 비교할 수 있게 되면 7단계로 넘어갑니다. 이 계산은 광고 관리자의 구매 수와 매출에 기대므로, 그 숫자가 실제 주문과 맞는지 7단계에서 대조합니다.' }
      ] },

      { t: 'step', num: 7, id: 's7', title: '광고 관리자 숫자와 실제 주문이 다름', fields: [
        { label: '보이는 증상', text: '광고 관리자의 구매 수 · 매출이 쇼핑몰 실제 주문이나 GA4와 다릅니다.' },
        { label: '가능한 원인', items: [
          '기여 기간과 기여 설정이 도구마다 다릅니다(어트리뷰션 차이).',
          '시간대나 날짜 기준(노출 시점인지 구매 시점인지)이 다릅니다.',
          '픽셀 · GA4 · 광고 플랫폼이 구매를 세는 기준이 다릅니다.',
          '같은 구매 이벤트가 두 번 이상 전송됩니다(중복 이벤트).',
          '테스트 주문이나 취소 주문이 섞여 있습니다.',
          'UTM이 없거나 값이 제각각이라 유입 경로가 나뉘지 않습니다.',
          '일부 지표는 추산치이거나 통계 모델링이 쓰입니다.'
        ] },
        { label: '먼저 확인할 것', items: [
          '같은 기간, 같은 시간대, 같은 날짜 기준으로 광고 관리자 · GA4 · 쇼핑몰 주문 목록 세 곳을 표로 대조합니다.',
          '실제 주문(결제 완료)을 기준값으로 삼고, 테스트 · 취소 주문은 뺍니다.',
          '두 도구의 기여 기간과 시간대가 같은지 확인합니다.',
          '테스트 주문으로 구매 이벤트가 한 주문당 1번만 기록되는지 확인합니다.',
          'UTM 값의 대소문자와 철자가 일관된지 확인합니다.'
        ] },
        { label: '바로 할 수 있는 조치', items: [
          '중복이 확인되면 구매 이벤트가 주문당 한 번만 나가도록 고칩니다. GA4에서는 주문 고유번호(transaction_id)를 함께 보내면 같은 주문의 중복 집계를 줄일 수 있습니다.',
          'UTM 이름 규칙을 소문자로 통일합니다.',
          '두 도구의 기여 기간과 시간대를 맞춘 뒤 비교합니다.',
          '기록표에 "실제 주문 기준" 열을 추가합니다.'
        ] },
        { label: '다음 단계로 넘어가는 기준', text: '차이의 이유를 설명할 수 있으면(기준 차이) 광고 숫자는 방향을 읽는 참고로 쓰고, 이익 판단은 실제 주문으로 합니다. 설명되지 않는 큰 차이가 계속되면 추적 오류로 보고, 성과를 판단하기 전에 이 단계의 설정부터 고칩니다. 추적이 정확하다는 확인이 끝나면 1단계부터 다시 위에서 아래로 점검합니다.' }
      ] },

      { t: 'h3', text: '증상별 진단 요약' },
      { t: 'table', caption: '증상별 진단 요약', head: ['보이는 증상', '먼저 볼 것', '이동'], rows: [
        ['노출수가 0이거나 거의 없다', '캠페인 상태, 심사, 결제수단, 일정, 예산, 타깃 범위, 계정 제한', { text: '1단계로 이동', jump: 's1' }],
        ['노출은 있는데 클릭이 적다', '소재 첫 화면, 상품과 메시지의 일치, 혜택, 타깃, 문구', { text: '2단계로 이동', jump: 's2' }],
        ['클릭은 있는데 랜딩페이지 조회가 적다', '잘못된 URL, 모바일 로딩, 페이지 오류, 리디렉션, 픽셀', { text: '3단계로 이동', jump: 's3' }],
        ['방문은 있는데 장바구니가 적다', '가격, 상품 이해도, 상세페이지, 배송비, 후기, 옵션', { text: '4단계로 이동', jump: 's4' }],
        ['장바구니는 있는데 구매가 적다', '결제 오류, 추가 배송비, 회원가입 강제, 쿠폰, 결제수단, 교환 · 반품 불안', { text: '5단계로 이동', jump: 's5' }],
        ['구매는 나오는데 남는 돈이 없다', 'CPA, 객단가, 할인, 변동비, 반품, 손익분기 ROAS', { text: '6단계로 이동', jump: 's6' }],
        ['광고 관리자 숫자와 실제 주문이 다르다', '기여 기간, 픽셀 · GA4 집계 기준, 중복 이벤트, 테스트 주문, UTM', { text: '7단계로 이동', jump: 's7' }]
      ] },
